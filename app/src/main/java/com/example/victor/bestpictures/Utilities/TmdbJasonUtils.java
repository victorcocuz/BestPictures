...
import com.example.victor.bestpictures.Model.ReviewItem;
...
public class TmdbJasonUtils {

    private final static String LOG_TAG = TmdbJasonUtils.class.getSimpleName();
    ...
    public static MovieItem extractDataFromTmdbJsonMovie(String tmdbJsonResponse) {
        ...
        try {
            ...
            movieList = new MovieItem(jsonID,
                    jsonBackdrop,
                    jsonBudget,
                    jsonGenres,
                    jsonOverview,
    ...
    public static List<MovieItem> extractDataFromTmdbJsonDiscover(String tmdbJsonResponse) {
